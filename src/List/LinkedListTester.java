...
public class LinkedListTester {
	...
	// data(회원번호+이름)
	static class Data {
		static final int NO = 1; // 번호를 입력 받는가?
		static final int NAME = 2; // 이름을 입력 받는가?

		private Integer no; // 회원번호
		private String name; // 이름

		// 문자열을 반환합니다. toString() 오버라이딩
		...
		enum Menu {
			...
			private final String message;		//출력할 위의 문자열
